...
<div style="font-size:11.0pt; text-align:center">
  <b>
    Fecha de Recepción:  <?php
                     foreach($hidroxidos->result() as $row){
...
<div style="font-size:12.0pt;"> &nbsp&nbsp&nbsp <b>Hidróxidos: </b></div>
              ...
              <thead>
                <tr style="background-color: #D9D9D9;">
                 <th><div style="width: 90px;" >Fecha del Ensayo</div></th>
                  ...
                  <th><div style="width: 90px;">N H<sub>2</sub>SO<sub>4</sub></th>
                  <th><div style="width: 90px;">V (mL) H<sub>2</sub>SO<sub>4</sub> pH=8,3</th>
                  <th><div style="width: 90px;">pH (Unidades)</th>
                  <th><div style="width: 90px;">Resultado (mg CaCO<sub>3</sub>/L)</th>
                  <th><div style="width: 90px;">V (mL) H<sub>2</sub>SO<sub>4</sub> pH=4,5</th>
                  <th><div style="width: 90px;">pH (Unidades)</th>
                  <th><div style="width: 90px;">Resultado Carbonatos (mg CaCO<sub>3</sub>/L)</th>
                  <th><div style="width: 90px;">Promedio Carbonatos(mg CaCO<sub>3</sub>/L)</th>
