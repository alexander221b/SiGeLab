...
<head>
  ...
  <title>Consultar Recepciones</title>
  <!-- Bootstrap Core CSS -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Consultar Recepciones <small>Búsqueda de recepción</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
...
<?php       
  if (isset($recepcionEliminada)){
    echo "
      <div class='alert alert-danger'>
      <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
      La <strong>Cotización No. ".$recepcionEliminada."</strong> ha sido eliminada de la base de datos.
      </div> 
    "; 
  }
?>  
...
<?php       
  if (isset($recepcionNoEncontrada)){
    echo "
      <div class='alert alert-danger'>
      <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
      La búsqueda <strong>Codigo Interno ó Cotización No. ".$recepcionNoEncontrada."</strong> no existe en la base de datos.
      </div> 
    "; 
  }
?>           

<?php echo form_open('welcome/buscarRecepcion'); ?>
<div class="row">
  <div class="col-lg-4">
    <div class="input-group">
      <input type="text" name="CotizacionNoCodigoInterno" class="form-control" placeholder="Codigo Interno ó No. de cotización" required>
...
<?php   
  if (isset($resultadoBusqueda)) {
    ...
    echo $this->table->generate($recepciones);
...
<div id="container">
  <div id="body">
    ...
    <?php if (isset($noExisteRecepcion)) {echo $noExisteRecepcion;} ?>
