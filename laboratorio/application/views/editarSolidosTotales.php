       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Editar Resultados <small>Sólidos Totales</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
                            ...
                            <li>
                            <?php
                              foreach ($solidosTotales->result() as $row){
                                $codigoInterno = $row->codigoInterno;
                              }
                              $link = '<a class="ask" href="//localhost/laboratorio/index.php/welcome/verResultado/'.$codigoInterno.'/solidosTotales" target="_blank" onClick="window.open(this.href, this.target, width=300, height=400); return false;">'.$codigoInterno.'</a>';
                              echo $link;
                            ?> 
                          </li>
                        </ol>
          ...
          <?php 
            ...
            echo form_open('welcome/actualizarSolidosTotales'); 
          ?>
            ...
            <table class="table table-bordered" >
              <thead>
                <tr class="active">
                  ...
                  <th><div style="width: 100px;">Cápsula + muestra (105ºC)</th>
                  <th><div style="width: 100px;">Concentración S.T (mg/L)</th>
                  <th><div style="width: 100px;">Concentración Promedio S.T. (mg/L)</th>
              ...
              <tbody>
                <tr>
                  ...
                  <td><input value="<?php
                     foreach($solidosTotales->result() as $row){
                       $concentracionSt1 = $row->concentracionSt1;
                      } echo $concentracionSt1?>" name="concentracionSt1" id="concentracionSt1" type="text" class="form-control"></td>
                  <td rowspan="2"><textarea name="concentracionPromedioSt" id="concentracionPromedioSt" class="form-control" rows="5" ><?php
                     foreach($solidosTotales->result() as $row){
                       $concentracionPromedioSt = $row->concentracionPromedioSt;
                      } echo $concentracionPromedioSt?></textarea></td>
                ...
                <tr>
                  ...
                  <td><input value="<?php
                     foreach($solidosTotales->result() as $row){
                       $concentracionSt2 = $row->concentracionSt2;
                      } echo $concentracionSt2?>" name="concentracionSt2" id="concentracionSt2" type="text" class="form-control"></td>
                </tr>
                <tr class="active">
                  <td colspan="10" >
                    <div class="row">
