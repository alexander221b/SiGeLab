       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Editar Resultados <small>Sólidos Disueltos Volátiles</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
                            ...
                            <?php
                              ...
                              $link = '<a class="ask" href="//localhost/laboratorio/index.php/welcome/verResultado/'.$codigoInterno.'/solidosDisueltosVolatiles" target="_blank" onClick="window.open(this.href, this.target, width=300, height=400); return false;">'.$codigoInterno.'</a>';
                              echo $link;
                            ?> 
                          </li>
                        </ol>
          ...
          <?php 
            ...
            echo form_open('welcome/actualizarSolidosDisueltosVolatiles'); 
          ?>
            ...
            <table class="table table-bordered" >
              <thead>
                <tr class="active">
                  ...
                  <th><div style="width: 100px;">Cápsula + muestra (550ºC)</th>
                  <th><div style="width: 100px;">Concentración S.D.V (mg/L)</th>
                  <th><div style="width: 100px;">Concentración Promedio S.D.V (mg/L)</th>
                ...
                <tr>
                  ...
                  <td><input <input value="<?php
                     foreach($solidosDisueltosVolatiles->result() as $row){
                      ...
                      } echo $vAlicuotaMuestraFiltrada1?>" name="vAlicuotaMuestraFiltrada1" id="vAlicuotaMuestraFiltrada1" type="text" class="form-control"></td>                
                  <td><input <input value="<?php
                     foreach($solidosDisueltosVolatiles->result() as $row){
                  ...
                  <td><input <input value="<?php
                     foreach($solidosDisueltosVolatiles->result() as $row){
                      ...
                      } echo $capsulaVacia1?>" name="capsulaVacia1" id="capsulaVacia1" type="text" class="form-control"></td>
                  <td><input <input value="<?php
                     foreach($solidosDisueltosVolatiles->result() as $row){
                  ...
                  <td><input <input value="<?php
                     foreach($solidosDisueltosVolatiles->result() as $row){
                      ...
                      } echo $capsulaMuestra1?>" name="capsulaMuestra1" id="capsulaMuestra1" type="text" class="form-control"></td>
                  <td><input <input value="<?php
                     foreach($solidosDisueltosVolatiles->result() as $row){
                       $concentracionSdv1 = $row->concentracionSdv1;
                      } echo $concentracionSdv1?>" name="concentracionSdv1" id="concentracionSdv1" type="text" class="form-control"></td>
                  <td rowspan="2"><textarea name="concentracionPromedioSdv" id="concentracionPromedioSdv" class="form-control" rows="5" ><?php
                     foreach($solidosDisueltosVolatiles->result() as $row){
                       $concentracionPromedioSdv = $row->concentracionPromedioSdv;
                      } echo $concentracionPromedioSdv?></textarea></td>
                ...
                <tr>
                  <td><input <input value="<?php
                     foreach($solidosDisueltosVolatiles->result() as $row){
                      ...
                      } echo $vAlicuotaMuestraFiltrada2?>" name="vAlicuotaMuestraFiltrada2" id="vAlicuotaMuestraFiltrada2" type="text" class="form-control"></td>                  
                  <td ><input <input value="<?php
                     foreach($solidosDisueltosVolatiles->result() as $row){
                  ...
                  <td><input <input value="<?php
                     foreach($solidosDisueltosVolatiles->result() as $row){
                      ...
                      } echo $capsulaVacia2?>" name="capsulaVacia2" id="capsulaVacia2" type="text" class="form-control"></td>
                  <td><input <input value="<?php
                     foreach($solidosDisueltosVolatiles->result() as $row){
                  ...
                  <td><input <input value="<?php
                     foreach($solidosDisueltosVolatiles->result() as $row){
                      ...
                      } echo $capsulaMuestra2?>" name="capsulaMuestra2" id="capsulaMuestra2" type="text" class="form-control"></td>
                  <td><input <input value="<?php
                     foreach($solidosDisueltosVolatiles->result() as $row){
                       $concentracionSdv2 = $row->concentracionSdv2;
                      } echo $concentracionSdv2?>" name="concentracionSdv2" id="concentracionSdv2" type="text" class="form-control"></td>
                </tr>
                <tr class="active">
                  <td colspan="10" >
                    <div class="row">
