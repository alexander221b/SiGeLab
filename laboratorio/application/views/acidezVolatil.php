       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Registrar Resultados <small>Acidéz Volátil</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
          ...
          <?php 
            ...
            echo form_open('welcome/registrarAcidezVolatil'); 
          ?>
            ...
            <table class="table table-bordered" >
              ...
              <tbody>
                <tr>
                  ...
                  <td><input name="acidezVolatil1" id="acidezVolatil1" type="text" class="form-control"></td>
                  <td><input name="acidezFija1" id="acidezFija1" type="text" class="form-control"></td>
                ...
                <tr>
                  ...
                  <td><input name="acidezVolatil2" id="acidezVolatil2" type="text" class="form-control"></td>
                  <td><input name="acidezFija2" id="acidezFija2" type="text" class="form-control"></td>
                </tr>
                <tr class="active">
                  <td colspan="9" >
                    <div class="row">
