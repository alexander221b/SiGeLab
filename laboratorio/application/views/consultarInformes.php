                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Consultar Informes <small>Búsqueda de Informe</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
...
<?php echo form_open('welcome/buscarInforme'); ?>
<div class="row">
  <div class="col-lg-4">
    <div class="input-group">
      <input type="text" name="CotizacionNoNitCc" class="form-control" placeholder="No. de cotización ó Nit/CC" required>
...
<div id="container">
  <div id="body">
    ...
    <?php 
      if (!isset($resultadoBusqueda)){
        echo $this->table->generate($informes);
        if (isset($noExisteInforme)) {
          echo $noExisteInforme;
        }
