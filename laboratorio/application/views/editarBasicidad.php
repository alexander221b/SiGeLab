       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Editar Resultados <small>Basicidad</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
                            ...
                            <?php
                              ...
                              $link = '<a class="ask" href="//localhost/laboratorio/index.php/welcome/verResultado/'.$codigoInterno.'/basicidad" target="_blank" onClick="window.open(this.href, this.target, width=300, height=400); return false;">'.$codigoInterno.'</a>';
                              echo $link;
                            ?> 
                          </li>
                        </ol>
          ...
          <?php 
            ...
            echo form_open('welcome/actualizarBasicidad'); 
          ?>
                ...
                <tr>
                  ...
                  <td><input value="<?php
                     foreach($basicidad->result() as $row){
                      ...
                      } echo $gMlMuestra1?>" name="gMlMuestra1" id="gMlMuestra1" type="text" class="form-control"></td>                
                  <td><input value="<?php
                     foreach($basicidad->result() as $row){
                       $vFinal1 = $row->vFinal1;
                ...
                <tr>
                  <td><input value="<?php
                     foreach($basicidad->result() as $row){
                      ...
                      } echo $gMlMuestra2?>" name="gMlMuestra2" id="gMlMuestra2" type="text" class="form-control"></td>                  
                  <td ><input value="<?php
                     foreach($basicidad->result() as $row){
                       $vFinal2 = $row->vFinal2;
