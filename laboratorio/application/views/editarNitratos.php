       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Editar Resultados <small>Nitratos</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
                            ...
                            <?php
                              ...
                              $link = '<a class="ask" href="//localhost/laboratorio/index.php/welcome/verResultado/'.$codigoInterno.'/nitratos" target="_blank" onClick="window.open(this.href, this.target, width=300, height=400); return false;">'.$codigoInterno.'</a>';
                              echo $link;
                            ?> 
                          </li>
                        </ol>
          ...
          <?php 
            ...
            echo form_open('welcome/actualizarNitratos'); 
          ?>
              ...
              <tbody>
                <tr>
                  ...
                  <td><input <input value="<?php
                     foreach($nitratos->result() as $row){
                       $abs2201 = $row->abs2201;
                      } echo $abs2201?>" name="abs2201" id="abs2201" type="text" class="form-control"></td>
                  <td><input <input value="<?php
                     foreach($nitratos->result() as $row){
                       $abs2751 = $row->abs2751;
                      } echo $abs2751?>" name="abs2751" id="abs2751" type="text" class="form-control"></td>
                  <td><input <input value="<?php
                     foreach($nitratos->result() as $row){
                ...
                <tr>
                  ...
                  <td><input <input value="<?php
                     foreach($nitratos->result() as $row){
                       $abs2202 = $row->abs2202;
                      } echo $abs2202?>" name="abs2202" id="abs2202" type="text" class="form-control"></td>
                  <td><input <input value="<?php
                     foreach($nitratos->result() as $row){
                       $abs2752 = $row->abs2752;
                      } echo $abs2752?>" name="abs2752" id="abs2752" type="text" class="form-control"></td>
                  <td><input <input value="<?php
                     foreach($nitratos->result() as $row){
                ...
                <tr>
                  ...
                  <td><input <input value="<?php
                     foreach($nitratos->result() as $row){
                      ...
                      } echo $abs220SolucionCartaControl?>" name="abs220SolucionCartaControl" id="abs220SolucionCartaControl" type="text" class="form-control"></td>
                  <td><input <input value="<?php
                     foreach($nitratos->result() as $row){
                       $abs275SolucionCartaControl = $row->abs275SolucionCartaControl;
                      } echo $abs275SolucionCartaControl?>" name="abs275SolucionCartaControl" id="abs275SolucionCartaControl" type="text" class="form-control"></td>
                  <td><input <input value="<?php
                     foreach($nitratos->result() as $row){
