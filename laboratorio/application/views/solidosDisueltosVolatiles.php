       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Registrar Resultados <small>Sólidos Disueltos Volátiles</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
          ...
          <?php 
            ...
            echo form_open('welcome/registrarSolidosDisueltosVolatiles'); 
          ?>
            ...
            <table class="table table-bordered" >
              ...
              <tbody>
                <tr>
                  ...
                  <td><input name="vAlicuotaMuestraFiltrada1" id="vAlicuotaMuestraFiltrada1" type="text" class="form-control"></td>                
                  <td><input name="noCapsula1" id="noCapsula1" type="text" class="form-control"></td>
                  <td><input name="capsulaVacia1" id="capsulaVacia1" type="text" class="form-control"></td>
                  <td><input name="crisolMuestra1" id="crisolMuestra1" type="text" class="form-control"></td>
                  <td><input name="capsulaMuestra1" id="capsulaMuestra1" type="text" class="form-control"></td>
                  <td><input name="concentracionSdv1" id="concentracionSdv1" type="text" class="form-control"></td>
                  <td rowspan="2"><textarea name="concentracionPromedioSdv" id="concentracionPromedioSdv" class="form-control" rows="5" ></textarea></td>
                  <td rowspan="2"><textarea name="responsable" id="responsable" class="form-control" rows="5" ></textarea></td>
                </tr>
                <tr>
                  <td><input name="vAlicuotaMuestraFiltrada2" id="vAlicuotaMuestraFiltrada2" type="text" class="form-control"></td>                  
                  <td ><input name="noCapsula2" id="noCapsula2" type="text" class="form-control"></td>
                  <td><input name="capsulaVacia2" id="capsulaVacia2" type="text" class="form-control"></td>
                  <td><input name="crisolMuestra2" id="crisolMuestra2" type="text" class="form-control"></td>
                  <td><input name="capsulaMuestra2" id="capsulaMuestra2" type="text" class="form-control"></td>
                  <td><input name="concentracionSdv2" id="concentracionSdv2" type="text" class="form-control"></td>
                </tr>
                <tr class="active">
                  <td colspan="10" >
                    <div class="row">
