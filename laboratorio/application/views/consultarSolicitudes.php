                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Consultar Solicitudes <small>Búsqueda de cotización</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
...
<?php       
  if (isset($solicitudEliminada)){
    echo "
      <div class='alert alert-danger'>
      <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
      La <strong>Solicitud No. ".$solicitudEliminada."</strong> ha sido eliminada de la base de datos.
      </div> 
    "; 
  }
?>  
...
<?php       
  if (isset($solicitudNoEncontrada)){
    echo "
      <div class='alert alert-danger'>
      <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
      La búsqueda <strong>Nit/CC No. ".$solicitudNoEncontrada."</strong> no existe en la base de datos.
      </div> 
    "; 
  }
?>           

<?php echo form_open('welcome/buscarSolicitud'); ?>
<div class="row">
  <div class="col-lg-4">
    <div class="input-group">
      <input type="text" name="nitCc" class="form-control" placeholder="Nit/Cédula" required>
...
<div id="container">
  <div id="body">
    <?php 
      if (!isset($resultadoBusqueda)){
        echo $this->table->generate($solicitudes);
        if (isset($noExisteSolicitud)) {
          echo $noExisteSolicitud;
        }
