       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Registrar Resultados <small>Sulfatos</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
          ...
          <?php 
            ...
            echo form_open('welcome/registrarSulfatos'); 
          ?>
            ...
            <table class="table table-bordered" >
              ...
              <tbody>
                <tr>
                  ...
                  <td><input name="turbiedad1" id="turbiedad1" type="text" class="form-control"></td>
                  <td rowspan="2"><input name="tBlanco" id="tBlanco" type="text" class="form-control"></td>
                ...
                <tr>
                  ...
                  <td><input name="turbiedad2" id="turbiedad2" type="text" class="form-control"></td>
                ...
                <tr>
                  ...
                  <td><input name="turbiedadSolucionCartaControl" id="turbiedadSolucionCartaControl" type="text" class="form-control"></td>
                  <td><input name="tBlancoSolucionCartaControl" id="tBlancoSolucionCartaControl" type="text" class="form-control"></td>
