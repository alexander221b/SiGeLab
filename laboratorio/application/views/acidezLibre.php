       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Registrar Resultados <small>Acidéz Libre</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
          ...
          <?php 
            ...
            echo form_open('welcome/registrarAcidezLibre'); 
          ?>
            ...
            <table class="table table-bordered" >
              <thead>
                <tr class="active">
                  ...
                  <th><div style="width: 100px;">Resultado (g ácido predominante/ 100 g)</th>
