       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Registrar Resultados <small>DBO5</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
          ...
          <?php 
            ...
            echo form_open('welcome/registrarDbo5'); 
          ?>
          <form class="form-horizontal" novalidate>
            <table class="table table-bordered" >
              ...
              <tbody>
                <tr>
                  <td rowspan="4"><input name="fechaEnsayo" id="fechaEnsayo" type="date" class="form-control"></td>
                  <td rowspan="3"><input name="codigoMuestra" id="codigoMuestra" type="text" class="form-control"></td>
                  <td><input name="winklerNo1" id="winklerNo1" type="text" class="form-control"></td>                
                  ...
                  <td><input name="odInicial1" id="odInicial1" type="text" class="form-control"></td>
                  <td><input name="odFinal1" id="odFinal1" type="text" class="form-control"></td>
                 ...
                 <tr>
                  <td><input name="winklerNo2" id="winklerNo2" type="text" class="form-control"></td>                
                  ...
                  <td><input name="odInicial2" id="odInicial2" type="text" class="form-control"></td>
                  <td><input name="odFinal2" id="odFinal2" type="text" class="form-control"></td>
                  <td><input name="concentracion2" id="concentracion2" type="text" class="form-control"></td>
                </tr>
                 <tr>                
                  <td><input name="winklerNo3" id="winklerNo3" type="text" class="form-control"></td>
                  <td><input name="factorDilucion3" id="factorDilucion3" type="text" class="form-control"></td>
                  <td><input name="vMuestra3" id="vMuestra3" type="text" class="form-control"></td>
                  <td><input name="odInicial3" id="odInicial3" type="text" class="form-control"></td>
                  <td><input name="odFinal3" id="odFinal3" type="text" class="form-control"></td>
                  <td><input name="concentracion3" id="concentracion3" type="text" class="form-control"></td>
                </tr>
                <tr>
                  <td>Solución Carta de Control</td>                  
                  <td ><input name="winklerNoSolucionCartaControl" id="winklerNoSolucionCartaControl" type="text" class="form-control"></td>
                  ...
                  <td><input name="odInicialSolucionCartaControl" id="odInicialSolucionCartaControl" type="text" class="form-control"></td>
                  <td><input name="odFinalSolucionCartaControl" id="odFinalSolucionCartaControl" type="text" class="form-control"></td>
