       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Registrar Resultados <small>Fosfatos</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
          ...
          <?php 
            ...
            echo form_open('welcome/registrarFosfatos'); 
          ?>
            ...
            <table class="table table-bordered" >
              ...
              <tbody>
                <tr>
                  ...
                  <td><input name="digestion1" id="digestion1" type="text" class="form-control"></td>
                  <td><input name="vFinalDigestion1"  id="vFinalDigestion1" type="text" class="form-control" ></td>
                  ...
                  <td><input name="concentracionPo1" id="concentracionPo1" type="text" class="form-control"></td>
                ...
                <tr>
                  <td><input name="digestion2" id="digestion2" type="text" class="form-control"></td>
                  <td><input name="vFinalDigestion2"  id="vFinalDigestion2" type="text" class="form-control" ></td>
                  ...
                  <td><input name="concentracionPo2" id="concentracionPo2" type="text" class="form-control"></td>
                </tr>
                <tr>
                  <td >Solución Carta de Control</td>
                  <td><input name="digestionSolucionCartaControl" id="digestionSolucionCartaControl" type="text" class="form-control"></td>
                  <td><input name="vFinalDigestionSolucionCartaControl"  id="vFinalDigestionSolucionCartaControl" type="text" class="form-control" ></td>
                  <td><input name="vAlicuotaSolucionCartaControl" id="vAlicuotaSolucionCartaControl" type="text" class="form-control"></td>
                  ...
                  <td><input name="concentracionPoSolucionCartaControl" id="concentracionPoSolucionCartaControl" type="text" class="form-control"></td>
