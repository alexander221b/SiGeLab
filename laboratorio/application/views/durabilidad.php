       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Registrar Resultados <small>Durabilidad</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
          ...
          <?php 
            ...
            echo form_open('welcome/registrarDurabilidad'); 
          ?>
            ...
            <table class="table table-bordered" >
              ...
              <tbody>
                <tr>
                  ...
                  <td><input name="gMuestra1" id="gMuestra1" type="text" class="form-control"></td>                
                  <td><input name="volumenH2SO41" id="volumenH2SO41" type="text" class="form-control"></td>
                  <td><input name="nH2SO41" id="nH2SO41" type="text" class="form-control"></td>
                  <td><input name="volumenNaOH1" id="volumenNaOH1" type="text" class="form-control"></td>
                  <td><input name="resutadoH2SO41" id="resutadoH2SO41" type="text" class="form-control"></td>
                  <td rowspan="2"><textarea name="promedioH2SO4" id="promedioH2So4" class="form-control" rows="5" ></textarea></td>
                  <td rowspan="3"><textarea name="responsable" id="responsable" class="form-control" rows="8" ></textarea></td>
                </tr>
                <tr>
                  <td><input name="gMuestra2" id="gMuestra2" type="text" class="form-control"></td>                  
                  <td><input name="volumenH2SO42" id="volumenH2SO42" type="text" class="form-control"></td>
                  <td><input name="nH2SO42" id="nH2SO42" type="text" class="form-control"></td>
                  <td><input name="volumenNaOH2" id="volumenNaOH2" type="text" class="form-control"></td>
                  <td ><input name="resutadoH2SO42" id="resutadoH2SO42" type="text" class="form-control"></td>
                </tr>
                <tr>
                  <td >Blanco</td>
                  <td><input name="gMuestraBlanco" id="gMuestraBlanco" type="text" class="form-control"></td>                  
                  <td><input name="volumenH2SO4Blanco" id="volumenH2SO4Blanco" type="text" class="form-control"></td>
                  <td><input name="nH2SO4Blanco" id="nH2SO4Blanco" type="text" class="form-control"></td>
                  <td><input name="volumenNaOHBlanco" id="volumenNaOHBlanco" type="text" class="form-control"></td>
                  <td><input name="resutadoH2SO4Blanco" id="resutadoH2SO4Blanco" type="text" class="form-control"></td>
                  <td><input name="promedioH2SO4Blanco" id="promedioH2SO4Blanco" type="text" class="form-control"></td>
                </tr>
                <tr class="active">
                  <td colspan="9" >
                    <div class="row">
