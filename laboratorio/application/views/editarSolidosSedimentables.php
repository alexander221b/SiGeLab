       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Editar Resultados <small>Sólidos Sedimentables</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
                            ...
                            <?php
                              ...
                              $link = '<a class="ask" href="//localhost/laboratorio/index.php/welcome/verResultado/'.$codigoInterno.'/solidosSedimentables" target="_blank" onClick="window.open(this.href, this.target, width=300, height=400); return false;">'.$codigoInterno.'</a>';
                              echo $link;
                            ?> 
                          </li>
                        </ol>
          ...
          <?php 
            ...
            echo form_open('welcome/actualizarSolidosSedimentables'); 
          ?>
              ...
              <tbody>
                <tr>
                  ...
                  <td><input value="<?php
                     foreach($solidosSedimentables->result() as $row){
                       $ss10 = $row->ss10;
                      } echo $ss10?>" name="ss10" id="ss10" type="text" class="form-control"></td>
                  <td><input  value="<?php
                     foreach($solidosSedimentables->result() as $row){
                       $ss60 = $row->ss60;
                      } echo $ss60?>" name="ss60" id="ss60" type="text" class="form-control"></td>
