       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Editar Resultados <small>Sólidos Disueltos Totales</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
                            ...
                            <?php
                              ...
                              $link = '<a class="ask" href="//localhost/laboratorio/index.php/welcome/verResultado/'.$codigoInterno.'/solidosDisueltosTotales" target="_blank" onClick="window.open(this.href, this.target, width=300, height=400); return false;">'.$codigoInterno.'</a>';
                              echo $link;
                            ?> 
                          </li>
                        </ol>
          ...
          <?php 
            ...
            echo form_open('welcome/actualizarSolidosDisueltosTotales'); 
          ?>
                ...
                <tr>
                  ...
                  <td><input value="<?php
                     foreach($solidosDisueltosTotales->result() as $row){
                      ...
                      } echo $concentracionSdt1?>" name="concentracionSdt1" id="concentracionSdt1" type="text" class="form-control"></td>
                  <td rowspan="2"><textarea name="concentracionPromedioSdt" id="concentracionPromedioSdt" class="form-control" rows="5" ><?php
                     foreach($solidosDisueltosTotales->result() as $row){
                       $concentracionPromedioSdt = $row->concentracionPromedioSdt;
                      } echo $concentracionPromedioSdt?></textarea></td>
                ...
                <tr>
                  ...
                  <td><input value="<?php
                     foreach($solidosDisueltosTotales->result() as $row){
                      ...
                      } echo $concentracionSdt2?>" name="concentracionSdt2" id="concentracionSdt2" type="text" class="form-control"></td>
                </tr>
                <tr class="active">
                  <td colspan="10" >
                    <div class="row">
