       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Registrar Resultados <small>Extracto Seco Total</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
          ...
          <?php 
            ...
            echo form_open('welcome/registrarExtractoSecoTotal'); 
          ?>
            ...
            <table class="table table-bordered" >
              ...
              <tbody>
                <tr>
                  ...
                  <td><input name="McapsulaVacia1" id="McapsulaVacia1" type="text" class="form-control"></td>
                  <td><input name="cantidadMuestra1" id="cantidadMuestra1" type="text" class="form-control"></td>
                  <td><input name="mDespuesSecado11" id="mDespuesSecado11" type="text" class="form-control"></td>
                  <td><input name="mdespuesSecado21" id="mdespuesSecado21" type="text" class="form-control"></td>
                  <td><input name="extractoSecoTotal1" id="extractoSecoTotal1" type="text" class="form-control"></td>
                  <td rowspan="2"><textarea name="promedioEst" id="promedio" class="form-control" rows="5" ></textarea></td>
                ...
                <tr>
                  ...
                  <td ><input name="McapsulaVacia2" id="McapsulaVacia2" type="text" class="form-control"></td>
                  <td><input name="cantidadMuestra2" id="cantidadMuestra2" type="text" class="form-control"></td>
                  <td><input name="mDespuesSecado12" id="mDespuesSecado12" type="text" class="form-control"></td>
                  <td><input name="mdespuesSecado22" id="mdespuesSecado22" type="text" class="form-control"></td>
                  <td><input name="extractoSecoTotal2" id="extractoSecoTotal2" type="text" class="form-control"></td>
                </tr>
                <tr class="active">
                  <td colspan="10" >
                    <div class="row">
