       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Registrar Resultados <small>Hidrocarburos</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
          ...
          <?php 
            ...
            echo form_open('welcome/registrarHidrocarburos'); 
          ?>
          <form class="form-horizontal" novalidate>
            <table class="table table-bordered" >
              ...
              <tbody>
                <tr>
                  <td> <input name="fechaEnsayo" id="fechaEnsayo" type="date" class="form-control"></td>
                  <td><input name="codigoMuestra" id="codigoMuestra" type="text" class="form-control"></td>
                  <td><input name="vMuestraFiltrada" id="vMuestraFiltrada" type="text" class="form-control"></td>                
                  <td><input name="noCapsula" id="noCapsula" type="text" class="form-control"></td>
                  <td><input name="capsulaVacia" id="capsulaVacia" type="text" class="form-control"></td>
                  <td><input name="capsulaMuestra" id="capsulaMuestra" type="text" class="form-control"></td>
                  <td><input name="resultado" id="resultado" type="text" class="form-control"></td>
                  <td><textarea name="responsable" id="responsable" class="form-control"></textarea></td>
                </tr>
                <tr class="active">
                  <td colspan="9" >
                    <div class="row">
