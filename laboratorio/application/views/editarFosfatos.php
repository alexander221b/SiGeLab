       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Editar Resultados <small>Fosfatos</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
                            ...
                            <?php
                              ...
                              $link = '<a class="ask" href="//localhost/laboratorio/index.php/welcome/verResultado/'.$codigoInterno.'/fosfatos" target="_blank" onClick="window.open(this.href, this.target, width=300, height=400); return false;">'.$codigoInterno.'</a>';
                              echo $link;
                            ?> 
                          </li>
                        </ol>
          ...
          <?php 
            ...
            echo form_open('welcome/actualizarFosfatos'); 
          ?>
            ...
            <table class="table table-bordered" >
              <thead>
                <tr class="active">
                  ...
                  <th><div style="width: 100px;">(g o mL) digestión</th>
                  <th><div style="width: 100px;">V(mL) final digestión</th>
                  <th><div style="width: 100px;">V(mL) Alícuota</th>
                  <th><div style="width: 100px;">V(mL) final</th>
                  <th><div style="width: 100px;">Absorbancia</th>
                  <th><div style="width: 100px;">Concentración (mg P /L)</th>
                  <th><div style="width: 100px;">Concentración (mg PO<sub>4</sub><sup>3-</sup>/L)</th>
                  <th><div style="width: 100px;">Concentración Promedio (mg PO<sub>4</sub><sup>3-</sup>/L)</th>
                ...
                <tr>
                  ...
                  <td><input value="<?php
                     foreach($fosfatos->result() as $row){
                      ...
                      } echo $digestion1?>" name="digestion1" id="digestion1" type="text" class="form-control"></td>
                  <td><input value="<?php
                     foreach($fosfatos->result() as $row){
                       $vFinalDigestion1 = $row->vFinalDigestion1;
                      } echo $vFinalDigestion1?>" name="vFinalDigestion1"  id="vFinalDigestion1" type="text" class="form-control" ></td>
                  <td><input value="<?php
                     foreach($fosfatos->result() as $row){
                  ...
                  <td><input value="<?php
                     foreach($fosfatos->result() as $row){
                      ...
                      } echo $absorbancia1?>" name="absorbancia1" id="absorbancia1" type="text" class="form-control"></td>
                  <td><input value="<?php
                     foreach($fosfatos->result() as $row){
                  ...
                  <td><input value="<?php
                     foreach($fosfatos->result() as $row){
                      ...
                      } echo $concentracionPo1?>" name="concentracionPo1" id="concentracionPo1" type="text" class="form-control"></td>
                ...
                <tr>
                  <td><input value="<?php
                     foreach($fosfatos->result() as $row){
                      ...
                      } echo $digestion2?>" name="digestion2" id="digestion2" type="text" class="form-control"></td>
                  <td><input value="<?php
                     foreach($fosfatos->result() as $row){
                       $vFinalDigestion2 = $row->vFinalDigestion2;
                      } echo $vFinalDigestion2?>" name="vFinalDigestion2"  id="vFinalDigestion2" type="text" class="form-control" ></td>
                  <td><input value="<?php
                     foreach($fosfatos->result() as $row){
                  ...
                  <td><input value="<?php
                     foreach($fosfatos->result() as $row){
                      ...
                      } echo $absorbancia2?>" name="absorbancia2" id="absorbancia2" type="text" class="form-control"></td>
                  <td><input value="<?php
                     foreach($fosfatos->result() as $row){
                  ...
                  <td><input value="<?php
                     foreach($fosfatos->result() as $row){
                      ...
                      } echo $concentracionPo2?>" name="concentracionPo2" id="concentracionPo2" type="text" class="form-control"></td>
                </tr>
                <tr>
                  ...
                  <td><input value="<?php
                     foreach($fosfatos->result() as $row){
                      ...
                      } echo $digestionSolucionCartaControl?>" name="digestionSolucionCartaControl" id="digestionSolucionCartaControl" type="text" class="form-control"></td>
                  <td><input value="<?php
                     foreach($fosfatos->result() as $row){
                       $vFinalDigestionSolucionCartaControl = $row->vFinalDigestionSolucionCartaControl;
                      } echo $vFinalDigestionSolucionCartaControl?>" name="vFinalDigestionSolucionCartaControl"  id="vFinalDigestionSolucionCartaControl" type="text" class="form-control" ></td>
                  <td><input value="<?php
                     foreach($fosfatos->result() as $row){
                       $vAlicuotaSolucionCartaControl = $row->vAlicuotaSolucionCartaControl;
                      } echo $vAlicuotaSolucionCartaControl?>" name="vAlicuotaSolucionCartaControl" id="vAlicuotaSolucionCartaControl" type="text" class="form-control"></td>
                  <td><input value="<?php
                     foreach($fosfatos->result() as $row){
                  ...
                  <td><input value="<?php
                     foreach($fosfatos->result() as $row){
                       $concentracionSolucionCartaControl = $row->concentracionSolucionCartaControl;
                      } echo $concentracionSolucionCartaControl?>" name="concentracionPoSolucionCartaControl" id="concentracionPoSolucionCartaControl" type="text" class="form-control"></td>
                  <td><input value="<?php
                     foreach($fosfatos->result() as $row){
