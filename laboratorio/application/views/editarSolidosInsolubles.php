       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Editar Resultados <small>Sólidos Insolubles</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
                            ...
                            <?php
                              ...
                              $link = '<a class="ask" href="//localhost/laboratorio/index.php/welcome/verResultado/'.$codigoInterno.'/solidosInsolubles" target="_blank" onClick="window.open(this.href, this.target, width=300, height=400); return false;">'.$codigoInterno.'</a>';
                              echo $link;
                            ?> 
                          </li>
                        </ol>
          ...
          <?php 
            ...
            echo form_open('welcome/actualizarSolidosInsolubles'); 
          ?>
                ...
                <tr>
                  ...
                  <td><input value="<?php
                     foreach($solidosInsolubles->result() as $row){
                      ...
                      } echo $conentracionSi1?>" name="conentracionSi1" id="conentracionSi1" type="text" class="form-control"></td>
                  <td rowspan="2"><textarea name="concentracionPromedioSi" id="concentracionPromedioSi" class="form-control" rows="5" ><?php
                     foreach($solidosInsolubles->result() as $row){
                       $concentracionPromedioSi = $row->concentracionPromedioSi;
                      } echo $concentracionPromedioSi?></textarea></td>
                ...
                <tr>
                  ...
                  <td><input value="<?php
                     foreach($solidosInsolubles->result() as $row){
                      ...
                      } echo $conentracionSi2?>" name="conentracionSi2" id="conentracionSi2" type="text" class="form-control"></td>
                </tr>
                <tr class="active"> 
                  <td colspan="10" >
                    <div class="row">
