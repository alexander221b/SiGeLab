...
"><i class="fa fa-fw fa-power-off"></i> Cerrar Sesión </a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Editar Resultados <small>Carbonatos</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
                            ...
                            <li>
                            <?php
                              foreach ($carbonatos->result() as $row){
                                $codigoInterno = $row->codigoInterno;
                              }
                              $link = '<a class="ask" href="//localhost/laboratorio/index.php/welcome/verResultado/'.$codigoInterno.'/carbonatos" target="_blank" onClick="window.open(this.href, this.target, width=300, height=400); return false;">'.$codigoInterno.'</a>';
                              echo $link;
                            ?> 
                          </li>
                        </ol>
 ...
 if (isset($analisisActualizado)){
            ...
            echo form_open('welcome/actualizarCarbonatos'); 
          ?>
