                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Registrar Solicitud <small>Formulario de registro</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
...
<?php
  if (isset($solicitudRegistrada)){
    echo " 
      <div class='alert alert-info'>
        <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
        La <strong>Solicitud No. ".$solicitudRegistrada."</strong>
...
<div class="margenGuia">
    ...
    <br>
    <?php 
      echo form_open('welcome/registrarSolicitud'); 
    ?>
    <table border="1" style="width: 720px; text-align: center;  color:black; font-size:10.0pt; border-right:solid black 1.5pt; border-left:solid black 1.5pt; border-top:solid black 1.5pt;">
      ...
      <tr>
        <td colspan="5" style="width: 100px;"><input  style="width: 240px; height: 26px"  type="date" name="fecha" required></td>
      </tr>
    </table>
    ...
    <table border="1" style=" border-left:solid black 1.5pt; border-bottom:solid black 1.5pt; border-right:solid black 1.5pt; width: 720px; text-align: center; color:black; font-size:10.0pt;">
      <tr>
        <td colspan="4" style="text-align: left;">
          Razón Social: <input type="text" name="razonSocial" style="width: 324px"   required>
        </td>
        <td colspan="6" style="text-align: left; ">    
          Nit o C.C : <input type="text" name="nitCc" style="width: 221px;"   required></td>
      </tr>
      <tr>
        <td colspan="4" style="text-align: left">
          Solicitante: <input type="text" name="solicitante" style="width: 341px"   required>
        </td>
        <td colspan="6" style="text-align: left;">
          Cargo: <input type="text" name="cargo" style="width: 246px"    required>
        </td>
      </tr>
       <tr>
        <td colspan="4" style="text-align: left">Dirección: <input type="text" name="direccion" style="width: 347px" required></td>
        <td colspan="6" style=" text-align: left; ">Teléfono/Fax: <input type="text" name="telefonoFax"   style="width: 205px" required></td>
      </tr>
      <tr>
        <td colspan="4" style="text-align: left"> Municipio/Departamento: <input type="text" name="municipioDepartamento" style="width: 261px" required></td>
        <td colspan="6" style="text-align: left; ">Correo electrónico: <input type="email" name="correoElectronico" style="width: 175px" required></td>
      </tr>
    </table>
    <br>
    <form method="post">  
      <table id="tabla" border="1" style="width: 720px; border:solid black 1.5pt; color:black">
       <tr>
        <td>
           No. de Muestras: <input name="numeroMuestras" type="number">
           <br><br>Tipo de Muestras: <br><textarea name="tipoMuestras" rows=5 cols=98 spellcheck="true"> </textarea>
           <br><br>
           Parámetros: <br>
           <textarea name="parametros" rows=5 cols=98 spellcheck="true"></textarea>
         </td>
       </tr>  
        <tr>
        <td>
           <b>OBSERVACIONES:</b>
           <textarea name="observaciones" rows=5 cols=98 spellcheck="true"></textarea>
        </tr>
        </td>
        <tr>
        <td>
           Cotización Elaborada Por: <input name="cotizacionElaboradaPor"   type="text">
        </td>
       </tr>
   </table>
</div> 
