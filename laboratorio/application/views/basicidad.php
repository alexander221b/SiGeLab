       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Registrar Resultados <small>Basicidad</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
          ...
          <?php 
            ...
            echo form_open('welcome/registrarBasicidad'); 
          ?>
            ...
            <table class="table table-bordered" >
              <thead>
                <tr class="active">
                  ...
                  <th><div style="width: 100px;">g o mL de muestra</div></th>
                  <th><div style="width: 100px;">V (mL)  Final</div></th>
                  <th><div style="width: 100px;">N (Eq/L) NaOH</div></th>
                  <th><div style="width: 100px;">V (mL) NaOH</div></th>
                  <th><div style="width: 100px;">Resultado (g ácido predominante/ 100 g)</div></th>
                  <th><div style="width: 100px;">Promedio (g ácido predominante/ 100 g)</div></th>
              ...
              <tbody>
                <tr>
                  ...
                  <td><input name="gMlMuestra1" id="gMlMuestra1" type="text" class="form-control"></td>                
                  <td><input name="vFinal1" id="vFinal1" type="text" class="form-control"></td>
                  <td><input name="nNaOH1" id="nNaOH1" type="text" class="form-control"></td>
                  <td><input name="vNaOH1" id="vNaOH1" type="text" class="form-control"></td>
                  <td><input name="resultado1" id="resultado1" type="text" class="form-control"></td>
                  <td rowspan="2"><textarea name="promedio" id="promedio" class="form-control" rows="5" ></textarea></td>
                  <td rowspan="2"><textarea name="responsable" id="responsable" class="form-control" rows="5" ></textarea></td>
                </tr>
                <tr>
                  <td><input name="gMlMuestra2" id="gMlMuestra2" type="text" class="form-control"></td>                  
                  <td ><input name="vFinal2" id="vFinal2" type="text" class="form-control"></td>
                  <td><input name="nNaOH2" id="nNaOH2" type="text" class="form-control"></td>
                  <td><input name="vNaOH2" id="vNaOH2" type="text" class="form-control"></td>
