       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Editar Resultados <small>Acidez Libre</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
                            ...
                            <li>
                            <?php
                              foreach ($acidezLibre->result() as $row){
                                $codigoInterno = $row->codigoInterno;
                              }
                              $link = '<a class="ask" href="//localhost/laboratorio/index.php/welcome/verResultado/'.$codigoInterno.'/acidezLibre" target="_blank" onClick="window.open(this.href, this.target, width=300, height=400); return false;">'.$codigoInterno.'</a>';
                              echo $link;
                            ?> 
                          </li>
                        </ol>
          ...
          <?php 
            ...
            echo form_open('welcome/actualizarAcidezLibre'); 
          ?>
