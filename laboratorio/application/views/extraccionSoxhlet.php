       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Registrar Resultados <small>Extracción Soxhlet</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
          ...
          <?php 
            ...
            echo form_open('welcome/registrarExtraccionSoxhlet'); 
          ?>
            ...
            <table class="table table-bordered" >
              ...
              <tbody>
                <tr>
                  ...
                  <td><input name="noCrisol" id="noCrisol" type="text" class="form-control"></td>
                  <td><input name="pesoCrisolVacio" id="pesoCrisolVacio" type="text" class="form-control"></td>
                  <td><input name="pesoCrisolMuestra" id="pesoCrisolMuestra" type="text" class="form-control"></td>
