       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Registrar Resultados <small>Sólidos Suspendidos Volátiles</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
          ...
          <?php 
            ...
            echo form_open('welcome/registrarSolidosSuspendidosVolatiles'); 
          ?>
            ...
            <table class="table table-bordered" >
              ...
              <tbody>
                <tr>
                  ...
                  <td><input name="crisolMuestra5501" id="crisolMuestra5501" type="text" class="form-control"></td>
                  <td><input name="concentracionSsv1" id="concentracionSsv1" type="text" class="form-control"></td>
                  <td rowspan="2"><textarea name="concentracionPromedioSsv" id="concentracionPromedioSsv" class="form-control" rows="5" ></textarea></td>
                ...
                <tr>
                  ...
                  <td><input name="crisolMuestra5502" id="crisolMuestra5502" type="text" class="form-control"></td>
                  <td><input name="concentracionSsv2" id="concentracionSsv2" type="text" class="form-control"></td>
                </tr>
                <tr class="active">
                  <td colspan="10" >
                    <div class="row">
