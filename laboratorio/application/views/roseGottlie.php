       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Registrar Resultados <small>Rose Gottlie</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
          ...
          <?php 
            ...
            echo form_open('welcome/registrarRoseGottlie'); 
          ?>
            ...
            <table class="table table-bordered" >
              ...
              <tbody>
                <tr>
                  ...
                  <td><input name="noBeaker1" id="noBeaker1" type="text" class="form-control"></td>
                  <td><input name="pesoBeakerVacio1" id="pesoBeakerVacio1" type="text" class="form-control"></td>
                  <td><input name="pesoBeakerMuestra1" id="pesoBeakerMuestra1" type="text" class="form-control"></td>
                ...
                <tr>
                  ...
                  <td ><input name="noBeaker2" id="noBeaker2" type="text" class="form-control"></td>
                  <td><input name="pesoBeakerVacio2" id="pesoBeakerVacio2" type="text" class="form-control"></td>
                  <td><input name="pesoBeakerMuestra2" id="pesoBeakerMuestra2" type="text" class="form-control"></td>
