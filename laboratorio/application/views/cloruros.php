       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Registrar Resultados <small>Cloruros</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
          ...
          <?php 
            ...
            echo form_open('welcome/registrarCloruros'); 
          ?>
            ...
            <table class="table table-bordered" >
              ...
              <tbody>
                <tr>
                  ...
                  <td><input name="nAgno3Blanco" id="nAgno3Blanco" type="text" class="form-control"></td>
                  <td><input name="vAgno3Blanco" id="vAgno3Blanco" type="text" class="form-control"></td>
                  <td><input name="concentracionBlanco" id="concentracionBlanco" type="text" class="form-control"></td>
                  <td><input name="concentracionPromedioBlanco" id="concentracionPromedioBlanco" type="text" class="form-control"></td>                  
                ...
                <tr>
                  ...
                  <td><input name="nAgno31" id="nAgno31" type="text" class="form-control"></td>
                  <td><input name="vAgno31" id="vAgno31" type="text" class="form-control"></td>
                ...
                <tr>
                  ...
                  <td><input name="nAgno32" id="nAgno32" type="text" class="form-control"></td>
                  <td><input name="vAgno32" id="vAgno32" type="text" class="form-control"></td>
                ...
                <tr>
                  ...
                  <td><input name="nAgno3SolucionCartaControl" id="nAgno3SolucionCartaControl" type="text" class="form-control"></td>
                  <td><input name="vAgno3SolucionCartaControl" id="vAgno3SolucionCartaControl" type="text" class="form-control"></td>
