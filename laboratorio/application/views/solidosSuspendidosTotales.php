       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Registrar Resultados <small>Sólidos Suspendidos Totales</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
          ...
          <?php 
            ...
            echo form_open('welcome/registrarSolidosSuspendidosTotales'); 
          ?>
            ...
            <table class="table table-bordered" >
              ...
              <tbody>
                <tr>
                  ...
                  <td><input name="VmuestraFiltrada1" id="VmuestraFiltrada1" type="text" class="form-control"></td>                
                  ...
                  <td><input name="crisolMuestra1" id="crisolMuestra1" type="text" class="form-control"></td>
                  <td><input name="concentracionSst1" id="concentracionSst1" type="text" class="form-control"></td>
                  <td rowspan="2"><textarea name="concentracionPromedioSst" id="concentracionPromedioSst" class="form-control" rows="5" ></textarea></td>
                  <td rowspan="3"><textarea name="responsable" id="responsable" class="form-control" rows="8" ></textarea></td>
                </tr>
                <tr>
                  <td><input name="VmuestraFiltrada2" id="VmuestraFiltrada2" type="text" class="form-control"></td>                  
                  ...
                  <td><input name="crisolMuestra2" id="crisolMuestra2" type="text" class="form-control"></td>
                  <td ><input name="concentracionSst2" id="concentracionSst2" type="text" class="form-control"></td>
                </tr>
                <tr>
                  <td >Solución Carta Control</td>
                  <td><input name="VmuestraFiltradaSolucionCartaControl" id="VmuestraFiltradaSolucionCartaControl" type="text" class="form-control"></td>                  
                  <td><input name="noCrisolSolucionCartaControl" id="noCrisolSolucionCartaControl" type="text" class="form-control"></td>
                  <td><input name="crisolVacioSolucionCartaControl" id="crisolVacioSolucionCartaControl" type="text" class="form-control"></td>
                  <td><input name="crisolMuestraSolucionCartaControl" id="crisolMuestraSolucionCartaControl" type="text" class="form-control"></td>
                  <td><input name="concentracionSstSolucionCartaControl" id="concentracionSstSolucionCartaControl" type="text" class="form-control"></td>
                  <td><input name="concentracionPromedioSstSolucionCartaControl" id="concentracionPromedioSstSolucionCartaControl" type="text" class="form-control"></td>
                </tr>
                <tr class="active">
                  <td colspan="9" >
                    <div class="row">
