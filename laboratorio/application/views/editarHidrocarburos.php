       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Editar Resultados <small>Hidrocarburos</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
                            ...
                            <?php
                              ...
                              $link = '<a class="ask" href="//localhost/laboratorio/index.php/welcome/verResultado/'.$codigoInterno.'/hidrocarburos" target="_blank" onClick="window.open(this.href, this.target, width=300, height=400); return false;">'.$codigoInterno.'</a>';
                              echo $link;
                            ?> 
                          </li>
                        </ol>
          ...
          <?php 
            ...
            echo form_open('welcome/actualizarHidrocarburos'); 
          ?>
                ...
                <tr>
                  ...
                  <td><input value="<?php
                     foreach($hidrocarburos->result() as $row){
                      ...
                      } echo $vMuestraFiltrada?>" name="vMuestraFiltrada" id="vMuestraFiltrada" type="text" class="form-control"></td>                
                  <td><input value="<?php
                     foreach($hidrocarburos->result() as $row){
                       $noCapsula = $row->noCapsula;
                      } echo $noCapsula?>" name="noCapsula" id="noCapsula" type="text" class="form-control"></td>
                  <td><input value="<?php
                     foreach($hidrocarburos->result() as $row){
                       $capsulaVacia = $row->capsulaVacia;
                      } echo $capsulaVacia?>" name="capsulaVacia" id="capsulaVacia" type="text" class="form-control"></td>
                  <td><input value="<?php
                     foreach($hidrocarburos->result() as $row){
                       $capsulaMuestra = $row->capsulaMuestra;
                      } echo $capsulaMuestra?>" name="capsulaMuestra" id="capsulaMuestra" type="text" class="form-control"></td>
                  <td><input value="<?php
                     foreach($hidrocarburos->result() as $row){
                       $resultado = $row->resultado;
                      } echo $resultado?>" name="resultado" id="resultado" type="text" class="form-control"></td>
                  <td><textarea name="responsable" id="responsable" class="form-control"><?php
                     foreach($hidrocarburos->result() as $row){
