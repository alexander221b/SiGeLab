       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Registrar Resultados <small>Sólidos Sedimentables 10' - 60'</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
          ...
          <?php 
            ...
            echo form_open('welcome/registrarSolidosSedimentables'); 
          ?>
            ...
            <table class="table table-bordered" >
              ...
              <tbody>
                <tr>
                  ...
                  <td><input name="vMuestra" id="vMuestra" type="text" class="form-control"></td>                
                  <td><input name="ss10" id="ss10" type="text" class="form-control"></td>
                  <td><input name="ss60" id="ss60" type="text" class="form-control"></td>
