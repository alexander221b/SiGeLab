       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Editar Resultados <small>Rose Gottlie</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
                            ...
                            <?php
                              ...
                              $link = '<a class="ask" href="//localhost/laboratorio/index.php/welcome/verResultado/'.$codigoInterno.'/roseGottlie" target="_blank" onClick="window.open(this.href, this.target, width=300, height=400); return false;">'.$codigoInterno.'</a>';
                              echo $link;
                            ?> 
                          </li>
                        </ol>
          ...
          <?php 
            ...
            echo form_open('welcome/actualizarRoseGottlie'); 
          ?>
                ...
                <tr>
                  ...
                  <td><input value="<?php
                     foreach($roseGottlie->result() as $row){
                      ...
                      } echo $noBeaker1?>" name="noBeaker1" id="noBeaker1" type="text" class="form-control"></td>
                  <td><input value="<?php
                     foreach($roseGottlie->result() as $row){
                       $pesoBeakerVacio1 = $row->pesoBeakerVacio1;
                      } echo $pesoBeakerVacio1?>" name="pesoBeakerVacio1" id="pesoBeakerVacio1" type="text" class="form-control"></td>
                  <td><input value="<?php
                     foreach($roseGottlie->result() as $row){
                       $pesoBeakerMuestra1 = $row->pesoBeakerMuestra1;
                      } echo $pesoBeakerMuestra1?>" name="pesoBeakerMuestra1" id="pesoBeakerMuestra1" type="text" class="form-control"></td>
                  <td><input value="<?php
                     foreach($roseGottlie->result() as $row){
                ...
                <tr>
                  ...
                  <td ><input value="<?php
                     foreach($roseGottlie->result() as $row){
                      ...
                      } echo $noBeaker2?>" name="noBeaker2" id="noBeaker2" type="text" class="form-control"></td>
                  <td><input value="<?php
                     foreach($roseGottlie->result() as $row){
                       $pesoBeakerVacio2 = $row->pesoBeakerVacio2;
                      } echo $pesoBeakerVacio2?>" name="pesoBeakerVacio2" id="pesoBeakerVacio2" type="text" class="form-control"></td>
                  <td><input value="<?php
                     foreach($roseGottlie->result() as $row){
                       $pesoBeakerMuestra2 = $row->pesoBeakerMuestra2;
                      } echo $pesoBeakerMuestra2?>" name="pesoBeakerMuestra2" id="pesoBeakerMuestra2" type="text" class="form-control"></td>
                  <td><input value="<?php
                     foreach($roseGottlie->result() as $row){
