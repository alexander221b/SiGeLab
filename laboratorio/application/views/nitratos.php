       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Registrar Resultados <small>Nitratos</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
          ...
          <?php 
            ...
            echo form_open('welcome/registrarNitratos'); 
          ?>
            ...
            <table class="table table-bordered" >
              ...
              <tbody>
                <tr>
                  ...
                  <td><input name="abs2201" id="abs2201" type="text" class="form-control"></td>
                  <td><input name="abs2751" id="abs2751" type="text" class="form-control"></td>
                ...
                <tr>
                  ...
                  <td><input name="abs2202" id="abs2202" type="text" class="form-control"></td>
                  <td><input name="abs2752" id="abs2752" type="text" class="form-control"></td>
                ...
                <tr>
                  ...
                  <td><input name="abs220SolucionCartaControl" id="abs220SolucionCartaControl" type="text" class="form-control"></td>
                  <td><input name="abs275SolucionCartaControl" id="abs275SolucionCartaControl" type="text" class="form-control"></td>
