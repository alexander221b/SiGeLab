       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Registrar Resultados <small>Sólidos Totales</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
          ...
          <?php 
            ...
            echo form_open('welcome/registrarSolidosTotales'); 
          ?>
            ...
            <table class="table table-bordered" >
              ...
              <tbody>
                <tr>
                  ...
                  <td><input name="concentracionSt1" id="concentracionSt1" type="text" class="form-control"></td>
                  <td rowspan="2"><textarea name="concentracionPromedioSt" id="concentracionPromedioSt" class="form-control" rows="5" ></textarea></td>
                ...
                <tr>
                  ...
                  <td><input name="concentracionSt2" id="concentracionSt2" type="text" class="form-control"></td>
                </tr>
                <tr class="active">
                  <td colspan="10" >
                    <div class="row">
