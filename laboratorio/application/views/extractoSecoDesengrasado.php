       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Registrar Resultados <small>Extracto Seco Desengrasado</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
          ...
          <?php 
            ...
            echo form_open('welcome/registrarExtractoSecoDesengrasado'); 
          ?>
            ...
            <table class="table table-bordered" >
              ...
              <tbody>
                <tr>
                  ...
                  <td><input name="est1" id="est1" type="text" class="form-control"></td>                
                  <td><input name="grasa1" id="grasa1" type="text" class="form-control"></td>
                  <td><input name="cantidadMuestra1" id="cantidadMuestra1" type="text" class="form-control"></td>
                  <td><input name="densidad1" id="densidad1" type="text" class="form-control"></td>
                ...
                <tr>
                  <td><input name="est2" id="est2" type="text" class="form-control"></td>                  
                  <td ><input name="grasa2" id="grasa2" type="text" class="form-control"></td>
                  <td><input name="cantidadMuestra2" id="cantidadMuestra2" type="text" class="form-control"></td>
                  <td><input name="densidad2" id="densidad2" type="text" class="form-control"></td>
