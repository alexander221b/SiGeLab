       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Editar Resultados <small>Aluminio</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
                            ...
                            <?php
                              ...
                              $link = '<a class="ask" href="//localhost/laboratorio/index.php/welcome/verResultado/'.$codigoInterno.'/aluminio" target="_blank" onClick="window.open(this.href, this.target, width=300, height=400); return false;">'.$codigoInterno.'</a>';
                              echo $link;
                            ?> 
                          </li>
                        </ol>
          ...
          <?php 
            ...
            echo form_open('welcome/actualizarAluminio'); 
          ?>
            ...
            <table class="table table-bordered" >
              <thead>
                <tr class="active">
                  ...
                  <th><div style="width: 100px;">Concentración mg / L</th>
                  <th><div style="width: 100px;">Concentración Corregida mg Al / L</th>
                  <th><div style="width: 100px;">Concentración Promedio mg Al / L</th>
                ...
                <tr>
                  ...
                  <td><input value="<?php
                     foreach($aluminio->result() as $row){
                      ...
                      } echo $concentracionCorregida1?>" name="concentracionCorregida1" id="concentracionCorregida1" type="text" class="form-control"></td>
                  <td rowspan="2"><textarea name="concentracionPromedio" id="concentracionPromedio" class="form-control" rows="5" ><?php
                     foreach($aluminio->result() as $row){
                ...
                <tr>
                  ...
                  <td ><input value="<?php
                     foreach($aluminio->result() as $row){
                      ...
                      } echo $concentracionCorregida2?>" name="concentracionCorregida2" id="concentracionCorregida2" type="text" class="form-control"></td>
                </tr>
                <tr>
