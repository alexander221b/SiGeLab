       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Editar Resultados <small>Extracción Soxhlet</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
                            ...
                            <?php
                              ...
                              $link = '<a class="ask" href="//localhost/laboratorio/index.php/welcome/verResultado/'.$codigoInterno.'/extraccionSoxhlet" target="_blank" onClick="window.open(this.href, this.target, width=300, height=400); return false;">'.$codigoInterno.'</a>';
                              echo $link;
                            ?> 
                          </li>
                        </ol>
          ...
          <?php 
            ...
            echo form_open('welcome/actualizarExtraccionSoxhlet'); 
          ?>
                ...
                <tr>
                  ...
                  <td><input value="<?php
                     foreach($extraccionSoxhlet->result() as $row){
                      ...
                      } echo $noCrisol?>" name="noCrisol" id="noCrisol" type="text" class="form-control"></td>
                  <td><input value="<?php
                     foreach($extraccionSoxhlet->result() as $row){
                       $pesoCrisolVacio = $row->pesoCrisolVacio;
                      } echo $pesoCrisolVacio?>" name="pesoCrisolVacio" id="pesoCrisolVacio" type="text" class="form-control"></td>
                  <td><input value="<?php
                     foreach($extraccionSoxhlet->result() as $row){
                       $pesoCrisolMuestra = $row->pesoCrisolMuestra;
                      } echo $pesoCrisolMuestra?>" name="pesoCrisolMuestra" id="pesoCrisolMuestra" type="text" class="form-control"></td>
                  <td><input value="<?php
                     foreach($extraccionSoxhlet->result() as $row){
