       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Registrar Resultados <small>Sólidos Disueltos Totales</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
          ...
          <?php 
            ...
            echo form_open('welcome/registrarSolidosDisueltosTotales'); 
          ?>
            ...
            <table class="table table-bordered" >
              ...
              <tbody>
                <tr>
                  ...
                  <td><input name="concentracionSdt1" id="concentracionSdt1" type="text" class="form-control"></td>
                  <td rowspan="2"><textarea name="concentracionPromedioSdt" id="concentracionPromedioSdt" class="form-control" rows="5" ></textarea></td>
                ...
                <tr>
                  ...
                  <td><input name="concentracionSdt2" id="concentracionSdt2" type="text" class="form-control"></td>
                </tr>
                <tr class="active">
                  <td colspan="10" >
                    <div class="row">
