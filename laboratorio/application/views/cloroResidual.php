       ...
       <li class="active">
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Registrar Resultados <small>Cloro Residual</small>
                        </h1>
                        <ol class="breadcrumb">
                           <li>
          ...
          <?php 
            ...
            echo form_open('welcome/registrarCloroResidual'); 
          ?>
            ...
            <table class="table table-bordered" >
              ...
              <tbody>
                <tr>
                  ...
                  <td><input name="vFas1" id="vFas1" type="text" class="form-control"></td>
                  <td><input name="nFas1" id="nFas1" type="text" class="form-control"></td>
                  <td><input name="resultado1" id="resultado1" type="text" class="form-control"></td>
                  <td rowspan="2"><textarea name="promedio" id="promedio" type="text" class="form-control" rows="8"></textarea></td>
                  <td ><textarea name="responsable1" id="responsable1" class="form-control" rows="5" ></textarea></td>
                </tr>
                <tr>
                  ...
                  <td><input name="vFas2" id="vFas2" type="text" class="form-control"></td>
                  <td><input name="nFas2" id="nFas2" type="text" class="form-control"></td>
                  <td><input name="resultado2" id="resultado2" type="text" class="form-control"></td>
                  <td rowspan="2"><textarea name="responsable2" id="responsable2" class="form-control" rows="5" ></textarea></td>
                </tr>
                <tr>
                  ...
                  <td><input name="vFasSolucionCartaControl" id="vFasSolucionCartaControl" type="text" class="form-control"></td>
                  <td><input name="nFasSolucionCartaControl" id="nFasSolucionCartaControl" type="text" class="form-control"></td>
